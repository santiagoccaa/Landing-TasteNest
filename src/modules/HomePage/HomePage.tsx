...
export const HomePage = () => {
    return (
        ...
        <div className="bg-[url('/hero/hero.png')] bg-cover bg-center h-[calc(100vh-60px)] w-full">
            <Container>
                <Flex direction="colum" className="h-[calc(100vh-60px)] lg:flex-row">
                    <Flex direction="colum" justify="center" aling="start" className="w-full md:w-1/2 h-full max-h-[700px] relative" gap="6">
                    ...
                    <Flex direction="colum" justify="end" aling="center" className="pb-8 w-full md:w-1/2 lg:h-full h-fit max-h-[700px]">
                        <div className="w-80 h-40 rounded-2xl border-2 border-yellow relative overflow-hidden">
                            ...
                            <Flex justify="between" className="w-full h-full absolute top-0 right-0">
                                <Flex direction="colum" aling="start" className="p-4">
